...
| Motor | STM32H743 | Timer | Nối tới ESC |
|---:|---|---|---|
| 1 | PA6 | TIM3_CH1 | Signal ESC 1 |
| 2 | PA7 | TIM3_CH2 | Signal ESC 2 |
| 3 | PB0 | TIM3_CH3 | Signal ESC 3 |
| 4 | PB1 | TIM3_CH4 | Signal ESC 4 |
...
- Throttle 500: `1500 µs`
- Cả bốn motor nhận cùng một collective throttle
