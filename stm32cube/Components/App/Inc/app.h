...
#define APP_UART1_RX_LOG_ENABLE 0U
#endif
...
typedef struct
{
  ...
  uint32_t imu_rate_millihz;
  uint32_t imu_period_min_us;
  uint32_t imu_period_mean_us;
  uint32_t imu_period_max_us;
  uint32_t imu_read_min_us;
  uint32_t imu_read_mean_us;
  uint32_t imu_read_max_us;
  uint32_t pid_update_count;
  uint32_t pid_rate_millihz;
  uint32_t pid_period_min_us;
  uint32_t pid_period_mean_us;
  uint32_t pid_period_max_us;
  uint32_t pid_exec_min_us;
  uint32_t pid_exec_mean_us;
  uint32_t pid_exec_max_us;
